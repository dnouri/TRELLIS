"""
State compression utilities for TRELLIS client-server communication.

Handles LZ4 compression of generation state (Gaussian and mesh data)
for efficient transfer between server and client. The compressed state
is stored client-side in gr.State to maintain stateless server design.
